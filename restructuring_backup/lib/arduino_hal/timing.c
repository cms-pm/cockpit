...
// System clock frequency (160MHz as configured in stm32g4_config.c)
#define SYSTEM_CLOCK_HZ     160000000U
#define MICROSECOND_TICKS   (SYSTEM_CLOCK_HZ / 1000000U)  // 160 ticks per microsecond
...
void timing_init(void) {
    ...
    *STM32_SYSTICK_CTRL = SYSTICK_ENABLE | SYSTICK_TICKINT | SYSTICK_CLKSOURCE;
    ...
    debug_print("ComponentVM Timing Init: 1μs SysTick configured at 160MHz");
}
...
// Override weak symbol for SysTick handler (disabled for basic HAL testing)
#ifndef DISABLE_CUSTOM_TIMING
