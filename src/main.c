/*
 * Auto-generated main.c for ComponentVM Automated Test: test_button_validation
...
extern void run_test_button_validation_main(void);
...
int main(void) {
    ...
    run_test_button_validation_main();
